...
public class BaseTests {
    ...
    protected void printResult(MvcResult result, String param) throws Exception {
        System.out.println("接口路径：");
        System.out.println(result.getRequest().getMethod()+"————"+result.getRequest().getRequestURL());
        System.out.println("接口入参：");
        System.out.println(formatJson(param));
        System.out.println("接口出参：");
    ...
    protected void executeTest(String url, Map paramMap)throws Exception {
        ...
        MvcResult mvcResult = getMockMvc().perform(MockMvcRequestBuilders.post(url)
            ...
            .andReturn();
        printResult(mvcResult,param);
    }

    protected void printPage(ClientPage page) {
        String json = JSONObject.toJSONString(page);
        JSONObject jsonObject = JSONObject.parseObject(json);
        String beautifiedJSONString = JSONObject.toJSONString(jsonObject, true);
        log.info(beautifiedJSONString);
    }
